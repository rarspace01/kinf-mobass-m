...
public class HighScoreActivity extends Activity {
	...
	public void getHighscores(){
		...
		Cursor currentCursor=dbConn_.rawQuery("SELECT name, score, difficulty FROM highscore ORDER BY score DESC;",null);
		...
		ArrayAdapter<String> arrayAdapter =      
				new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1, highScoreList);
